...
import { FirstchartComponent } from './dashboard-chart/firstchart/firstchart.component';
...
export class DashboardComponent implements OnInit {
  @ViewChild(FirstchartComponent) chart!: FirstchartComponent;
  constructor() { }
  ...
  ngAfterViewInit() {
    ...
    t?.addEventListener('click', () => {
      ...
      this.chart.setChartdata(this.chart.first_chart_today);
    });

    // logic for week button when the user is on dashboard
